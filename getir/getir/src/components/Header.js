...
function Header() {
  return (
    <div className="bg-purple-700 h-11">
      <div className="container mx-auto flex justify-between">
        <div className="flex py-3 px-3 ">
          ...
          <a href="#" className="text-gray-100 font-bold px-3">
            getiryemek
          </a>
          <a href="#" className="text-gray-100 font-bold px-3">
            getirbüyük
        ...
        <div className="flex py-3 px-6 justify-between items-center text-center">
          <div className="flex px-5 ">
            <button className="px-2">
              <RiGlobalLine className="text-neutral-300 text-2xl"></RiGlobalLine>
            </button>
            <span className="text-neutral-300 text-m">TÜRKÇE(TR)</span>
          </div>

          <div className="flex px-5">
            <button className="px-2">
              <HiUser className="text-neutral-300 text-2xl"></HiUser>
            </button>
            <span className="text-neutral-300 text-m">Giriş Yap</span>
          </div>

          <div className="flex px-5">
            <button className="px-2">
              <HiUserPlus className="text-neutral-300 text-2xl"></HiUserPlus>
            </button>
            <span className="text-neutral-300 text-m">Kayıt Ol</span>
          </div>
        </div>
      </div>
    </div>
